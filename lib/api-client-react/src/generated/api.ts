 ...
 */
export const mpesaStkPush = async (mpesaPaymentRequest: MpesaPaymentRequest, options?: RequestInit): Promise<MpesaPaymentResult> => {

  return customFetch<MpesaPaymentResult>(getMpesaStkPushUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getMpesaStkPushMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof mpesaStkPush>>, TError,{data: BodyType<MpesaPaymentRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof mpesaStkPush>>, TError,{data: BodyType<MpesaPaymentRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof mpesaStkPush>>, {data: BodyType<MpesaPaymentRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type MpesaStkPushMutationResult = NonNullable<Awaited<ReturnType<typeof mpesaStkPush>>>
    export type MpesaStkPushMutationBody = BodyType<MpesaPaymentRequest>
    export type MpesaStkPushMutationError = ErrorType<void>

    /**
 * @summary Initiate M-Pesa STK push payment
 */
export const useMpesaStkPush = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof mpesaStkPush>>, TError,{data: BodyType<MpesaPaymentRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof mpesaStkPush>>,
        TError,
        {data: BodyType<MpesaPaymentRequest>},
        TContext
      > => {
      return useMutation(getMpesaStkPushMutationOptions(options));
    }

export const getGetMpesaStatusUrl = () => {




  return `/api/mpesa/status`
}

/**
 * @summary Check if M-Pesa is configured
 */
export const getMpesaStatus = async ( options?: RequestInit): Promise<MpesaConfigStatus> => {

  return customFetch<MpesaConfigStatus>(getGetMpesaStatusUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetMpesaStatusQueryKey = () => {
    return [
    `/api/mpesa/status`
    ] as const;
    }
...
export const getGetMpesaStatusQueryOptions = <TData = Awaited<ReturnType<typeof getMpesaStatus>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMpesaStatus>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetMpesaStatusQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getMpesaStatus>>> = ({ signal }) => getMpesaStatus({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getMpesaStatus>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetMpesaStatus<TData = Awaited<ReturnType<typeof getMpesaStatus>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMpesaStatus>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetMpesaStatusQueryOptions(options)
...
export const getListAboutSectionsUrl = () => {
 ...
 */
export const listAboutSections = async ( options?: RequestInit): Promise<AboutSection[]> => {

  return customFetch<AboutSection[]>(getListAboutSectionsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListAboutSectionsQueryKey = () => {
    return [
    `/api/about`
    ] as const;
    }
...
export const getListAboutSectionsQueryOptions = <TData = Awaited<ReturnType<typeof listAboutSections>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listAboutSections>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListAboutSectionsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listAboutSections>>> = ({ signal }) => listAboutSections({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listAboutSections>>, TError, TData> & { queryKey: QueryKey }
}

export type ListAboutSectionsQueryResult = NonNullable<Awaited<ReturnType<typeof listAboutSections>>>
export type ListAboutSectionsQueryError = ErrorType<unknown>
...
export function useListAboutSections<TData = Awaited<ReturnType<typeof listAboutSections>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listAboutSections>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListAboutSectionsQueryOptions(options)
...
export const getUpsertAboutSectionUrl = (key: string,) => {




  return `/api/about/${key}`
}

/**
 * @summary Create or update an About Us section
 */
export const upsertAboutSection = async (key: string,
    aboutSectionBody: AboutSectionBody, options?: RequestInit): Promise<AboutSection> => {

  return customFetch<AboutSection>(getUpsertAboutSectionUrl(key),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpsertAboutSectionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertAboutSection>>, TError,{key: string;data: BodyType<AboutSectionBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof upsertAboutSection>>, TError,{key: string;data: BodyType<AboutSectionBody>}, TContext> => {

const mutationKey = ['upsertAboutSection'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof upsertAboutSection>>, {key: string;data: BodyType<AboutSectionBody>}> = (props) => {
          const {key,data} = props ?? {};

          return  upsertAboutSection(key,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpsertAboutSectionMutationResult = NonNullable<Awaited<ReturnType<typeof upsertAboutSection>>>
    export type UpsertAboutSectionMutationBody = BodyType<AboutSectionBody>
    export type UpsertAboutSectionMutationError = ErrorType<unknown>

    /**
 * @summary Create or update an About Us section
 */
export const useUpsertAboutSection = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof upsertAboutSection>>, TError,{key: string;data: BodyType<AboutSectionBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof upsertAboutSection>>,
        TError,
        {key: string;data: BodyType<AboutSectionBody>},
        TContext
      > => {
      return useMutation(getUpsertAboutSectionMutationOptions(options));
    }
 ...
 */
export const createTeamMember = async (teamMemberBody: TeamMemberBody, options?: RequestInit): Promise<TeamMember> => {
...
export const getCreateTeamMemberMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createTeamMember>>, TError,{data: BodyType<TeamMemberBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createTeamMember>>, TError,{data: BodyType<TeamMemberBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createTeamMember>>, {data: BodyType<TeamMemberBody>}> = (props) => {
          const {data} = props ?? {};
...
export const updateTeamMember = async (id: number,
    teamMemberBody: TeamMemberBody, options?: RequestInit): Promise<TeamMember> => {
...
export const getUpdateTeamMemberMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTeamMember>>, TError,{id: number;data: BodyType<TeamMemberBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateTeamMember>>, TError,{id: number;data: BodyType<TeamMemberBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateTeamMember>>, {id: number;data: BodyType<TeamMemberBody>}> = (props) => {
          const {id,data} = props ?? {};
