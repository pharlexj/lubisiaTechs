...
import { Trash2, ShoppingBag, Smartphone, CreditCard, CheckCircle2, Loader2 } from "lucide-react";
        ...
        {mpesaAwaiting ? (
          <>
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Order #{orderId} has been recorded. If you don't receive the prompt,
              check your phone network or contact us on WhatsApp.
            </p>
          </>
        ) : (
            ...
            {paymentMethod === "later" && (
              <div className="bg-muted/40 rounded-xl p-4 text-sm text-muted-foreground">
                <p>
                  ...
                  <strong>{formData.customerPhone || "your phone number"}</strong>{" "}
