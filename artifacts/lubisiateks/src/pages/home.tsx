  ...
  return (
    <div className="w-full">
      ...
      <section className="py-16 bg-muted/50 border-b">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div data-reveal="up" data-delay="150" className="flex items-start gap-4">
              <div className="bg-primary/10 p-3 rounded-lg text-primary shrink-0">
            ...
            <div data-reveal="right" data-delay="300" className="flex items-start gap-4">
              <div className="bg-primary/10 p-3 rounded-lg text-primary shrink-0">
          ...
          {servicesLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {featuredServices.map((service, i) => (
                <Card key={service.id} data-testid={`card-service-${service.id}`} data-reveal="up" data-delay={String(i * 150)} className="hover-up border-border shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {PORTFOLIO.map((project, i) => (
              <div
                ...
                className="hover-up bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col gap-4"
              >
          ...
          {productsLoading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {featuredProducts.map((product, i) => (
                <Link key={product.id} href={`/shop/${product.id}`} className="group block" data-testid={`link-product-${product.id}`} data-reveal="up" data-delay={String(i * 100)}>
                  <div className="hover-up rounded-xl border border-border bg-card overflow-hidden shadow-sm hover:shadow-md transition-all">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
            {DIRECTORS.map((director, i) => (
              <div key={director.name} data-testid={`card-director-${director.name.replace(/\s+/g, "-").toLowerCase()}`} data-reveal={i % 2 === 0 ? "left" : "right"} data-delay={String(i * 150)} className="hover-up bg-card border border-border rounded-2xl p-8 shadow-sm flex gap-6">
      ...
      <section className="py-24 bg-primary text-primary-foreground text-center">
        <div className="container mx-auto px-4">
          <h2 data-reveal="up" className="text-3xl md:text-4xl font-bold mb-6">Ready to upgrade your IT infrastructure?</h2>
